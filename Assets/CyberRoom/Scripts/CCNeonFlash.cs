...
public class CCNeonFlash : MonoBehaviour 
{
    ...
    public string EmitString = "_EmissiveColor";
    ...
    void ColorSwitch()
    {
        ...
        if (SwitchModes == SwitchMode.simple)
        {
            ...
            if (mode == 0)
            {
                _Material.SetColor(EmitString, Color.black);
                if (LightSource) LightSource.GetComponent<Light>().intensity = 0;
            }
            else
            {
                _Material.SetColor(EmitString, MaxBright);
        ...
        else if (SwitchModes == SwitchMode.multi)
        {
            ...
            {
                _Material.SetColor(EmitString, MaxBright * 0.5f);
